...
license: MIT
compatibility: qmd CLI or MCP server
metadata:
  author: tobi
  version: "2.0.0"
user-invocable: true
...
Search markdown knowledge bases, notes, and documentation using QMD. This skill should be used when users ask to search notes, find documents, or look up information in their markdown collections.
...
Install the qmd CLI and set up your collections:
