...
If the architecture described is convoluted, trigger a diagram using `` tags (where X is a Mermaid diagram query) to visualize the mess. Do not do this for simple CRUD apps; it wastes my GPU cycles.
